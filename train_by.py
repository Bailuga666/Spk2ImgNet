...
def main():
    ...
    '''
    # Build model
    model = SpikeNet(in_channels=161, features=64, out_channels=1, win_r=80, win_step=80)
...
if __name__ == "__main__":
    if opt.preprocess:
        prepare_data(data_path="./Spk2ImgNet_train/train2/", patch_size=32, stride=32, h5_name='train')
    main()
